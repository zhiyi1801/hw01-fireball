...
void main()
{
        ...
        float scale = 5.0f;
        vec3 noiseDrive = (fs_Pos.xyz + vec3(u_Time, 0, 0)) * scale;
        
        color = mix(color, u_Color.rgb, fbm(noiseDrive) * 1.3);
        ...
        color = vec3(color.x * bias(0.9f, heightStrength), 
                    color.y * bias(0.7f, heightStrength), 
                    color.z * bias(0.8f, heightStrength)); 
